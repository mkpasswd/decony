...
{{#rows}}
<TR id="{{id}}">
<TD class= "name"><A href="./scene.php?id={{id}}&title={{name}}">{{name}}</A></TD><TD>{{modelid}}</TD><TD>{{config.reachable}}</TD><TD>{{config.battery}}</TD><TD>{{config.on}}</TD>
